...
class Window(QWidget):
    ...
    def initUI(self):
        ...
        enhance_button.clicked.connect(self.numbering)
        ...
        self.setLayout(Hbox)
        self.setGeometry(800, 300, 850, 365)
    ...
    def numbering(self):
        ...
        maxmoney = str(self.max_money_lineedit.text())
        maxmoney
        print(maxmoney[0])
        """
        for i in range(len(maxmoney / 3)):
            maxmoney.insert(i * 3, ',')
        Maxmoney = ""
        for i in range(len(maxmoney)):
            Maxmoney = Maxmoney + maxmoney[i]
        print(Maxmoney)
        """
